...
public class PageFragment3 extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        calorieSum1 = view.findViewById(R.id.calorieForm3_1);
        calorieSum2 = view.findViewById(R.id.calorieForm3_2);
        calorieSum3 = view.findViewById(R.id.calorieForm3_3);
        calorieSum4 = view.findViewById(R.id.calorieForm3_4);
        protainSum1 = view.findViewById(R.id.proteinForm3_1);
        protainSum2 = view.findViewById(R.id.proteinForm3_2);
        protainSum3 = view.findViewById(R.id.proteinForm3_3);
        protainSum4 = view.findViewById(R.id.proteinForm3_4);
        carbonSum1 = view.findViewById(R.id.carbonForm3_1);
        carbonSum2 = view.findViewById(R.id.carbonForm3_2);
        carbonSum3 = view.findViewById(R.id.carbonForm3_3);
        carbonSum4 = view.findViewById(R.id.carbonForm3_4);
        fatSum1 = view.findViewById(R.id.fatForm3_1);
        fatSum2 = view.findViewById(R.id.fatForm3_2);
        fatSum3 = view.findViewById(R.id.fatForm3_3);
        fatSum4 = view.findViewById(R.id.fatForm3_4);
        foodGramForm1 = view.findViewById(R.id.foodGramForm3_1);
        foodGramForm2 = view.findViewById(R.id.foodGramForm3_2);
        foodGramForm3 = view.findViewById(R.id.foodGramForm3_3);
        foodGramForm4 = view.findViewById(R.id.foodGramForm3_4);
    ...
    public void EiyouTotal (){
        ...
        String msg3_0Total = String.valueOf(msg1_0 + msg2_0 + msg3_0 + msg4_0);
        calorieTotalForm.setText(msg3_0Total);
        String msg3_1Total = String.valueOf(msg1_1 + msg2_1 + msg3_1 + msg4_1);
        protainTotalForm.setText(msg3_1Total);
        String msg3_2Total = String.valueOf(msg1_2 + msg2_2 + msg3_2 + msg4_2);
        carbonTotalForm.setText(msg3_2Total);
        String msg3_3Total = String.valueOf(msg1_3 + msg2_3 + msg3_3 + msg4_3);
        fatTotalForm.setText(msg3_3Total);
        Bundle result0 = new Bundle();
        result0.putString("totalCalorie3", msg3_0Total);
        result0.putString("totalProtein3", msg3_1Total);
        result0.putString("totalCarbon3", msg3_2Total);
        result0.putString("totalFat3", msg3_3Total);
        getParentFragmentManager().setFragmentResult("requestKey3_0", result0);
